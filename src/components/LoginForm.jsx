  ...
  return (
    <>
      <form className="space-y-5">
        {/* Email Input */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5 font-poppins" htmlFor="login-email">
            Email Address
          </label>
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="block text-sm font-medium text-gray-700 font-poppins" htmlFor="login-password">
              Password
            </label>
            <button
              type="button"
